...
//aActions=JSON.parse(hActions.innerText);
...
function downloadSVGAsText() {
  ...
  const sName=document.getElementById("target-flowName").innerHTML;
...
function downloadHTML(){
  ...
  sHTML=sHTML.replaceAll(' src="assets/js/diagramLoad.min.js">','>'+sJS);
  ...
  element.setAttribute("download", sName+" Diagram.html");
